...

{
  ...
  "org.bdgenomics.utils" %% "utils-misc" % "0.2.9" % "test" classifier "tests",
  "org.bdgenomics.utils" %% "utils-misc" % "0.2.9",
  "org.bdgenomics.utils" %% "utils-cli" % "0.2.9",
  "org.bdgenomics.utils" %% "utils-metrics" % "0.2.9" ,
  "org.bdgenomics.adam" %% "adam-core" % "0.20.1-SNAPSHOT",
