...

{
  ...
  "org.bdgenomics.utils" %% "utils-misc" % "0.2.11-SNAPSHOT" % "test" classifier "tests" excludeAll(excludeHadoop, excludeSpark),
  "org.bdgenomics.utils" %% "utils-misc" % "0.2.11-SNAPSHOT" excludeAll(excludeHadoop, excludeSpark),
  "org.bdgenomics.utils" %% "utils-cli" % "0.2.11-SNAPSHOT" excludeAll(excludeHadoop, excludeSpark),
  "org.bdgenomics.utils" %% "utils-metrics" % "0.2.11-SNAPSHOT" excludeAll(excludeHadoop, excludeSpark),
