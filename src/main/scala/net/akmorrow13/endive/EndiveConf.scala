...
class EndiveConf extends Serializable {
  ...
  @BeanProperty var sequenceLength: Int = 200

  /* Kernel approximation feature parameters */
  @BeanProperty var approxDim: Int = 256
  @BeanProperty var approxDimToUse: Int = 256
  @BeanProperty var mixtureWeight: Double = -1.0
  @BeanProperty var solveSample: Double = 1.0
...
object EndiveConf {
  def validate(conf: EndiveConf) {
   ...
   val allDeepSeaTfs = Array("HSF1", "Pol2-4H8", "Rad21", "CCNT2", "Pol3", "Pol2", "BHLHE40", "SIX5", "BCLAF1", "GATA3", "ZNF263", "SETDB1", "BRCA1", "TRIM28", "GR", "SP1", "SP2", "SP4", "CREB1", "MafK", "PLU1", "GATA2", "Pbx3", "MafF", "Znf143", "GTF2F1", "GATA-1", "GATA-2", "RFX5", "NFKB", "RBBP5", "FOXA1", "RUNX3", "UBF", "FOXA2", "USF-1", "ELK4", "TCF12", "SIN3A", "CTCF", "FOXP2", "BATF", "ZNF217", "MAZ", "Brg1", "NELFe", "ERalpha", "TCF7L2", "Pol2(phosphoS2)", "JARID1A", "PAX5-C20", "SIRT6", "CHD1", "ZKSCAN1", "CHD2", "SAP30", "IKZF1", "ARID3A", "GTF2B", "ELK1", "ZBTB33", "TR4", "ZZZ3", "TCF3", "ZNF274", "NF-E2", "eGFP-FOS", "AP-2gamma", "STAT3", "BRF1", "ZEB1", "TAF7", "GRp20", "TAF1", "Pol2(b)", "TBP", "HNF4G", "HNF4A", "GABP", "MEF2C", "MEF2A", "NRSF", "PRDM1", "PHF8", "p300", "HDAC1", "HDAC2", "YY1", "HDAC6", "SPT20", "Bach1", "eGFP-JunB", "JunD", "BRF2", "FOXM1", "TFIIIC-110", "HMGN3", "AP-2alpha", "CBX3", "PAX5-N19", "NANOG", "STAT2", "STAT1", "NA", "SMC3", "NR2F2", "USF2", "USF1", "FOSL1", "FOSL2", "PML", "BAF155", "Nrf1", "IRF3", "SRF", "Sin3Ak-20", "COREST", "E2F6", "BDP1", "RXRA", "IRF1", "WHIP", "eGFP-HDAC8", "KAP1", "IRF4", "STAT5A", "PU.1", "NFATC1", "ERRA", "BCL11A", "EZH2", "ELF1", "TAL1", "CtBP2", "MYBL2", "c-Jun", "TEAD4", "CEBPB", "NF-YB", "CEBPD", "Max", "UBTF", "Egr-1", "eGFP-GATA2", "ETS1", "SUZ12", "BAF170", "RPC155", "MTA3", "ZBTB7A", "c-Myc", "PGC1A", "POU5F1", "EBF1", "Ini1", "TBLR1", "NFIC", "THAP1", "NF-YA", "E2F4", "c-Fos", "E2F1", "ATF1", "CTCFL", "MBD4", "eGFP-JunD", "ATF3", "Mxi1", "HA-E2F1", "POU2F2", "BCL3", "ATF2")
